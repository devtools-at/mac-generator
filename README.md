...
<p align="center">
  <a href="https://devtools.at/tools/mac-generator"><img src="https://img.shields.io/badge/Try%20Online-DevTools.at-blue?style=for-the-badge" alt="Try Online"></a>
  <a href="https://www.npmjs.com/package/@devtools-at/mac-generator"><img src="https://img.shields.io/npm/v/@devtools-at/mac-generator?style=for-the-badge" alt="npm version"></a>
  <a href="https://www.npmjs.com/package/@devtools-at/mac-generator"><img src="https://img.shields.io/npm/dm/@devtools-at/mac-generator?style=for-the-badge" alt="npm downloads"></a>
  <img src="https://img.shields.io/badge/TypeScript-Ready-3178C6?style=for-the-badge&logo=typescript" alt="TypeScript Ready">
</p>

<p align="center">
  <b>Generate random MAC addresses</b>
</p>

<p align="center">
  <a href="https://devtools.at/tools/mac-generator">Online Tool</a> •
...
```bash
# npm
npm install @devtools-at/mac-generator

# yarn
yarn add @devtools-at/mac-generator

# pnpm
pnpm add @devtools-at/mac-generator
```

## Usage

```typescript
import { process } from '@devtools-at/mac-generator';
...
```typescript
import { encode, decode } from '@devtools-at/mac-generator';
```

### CommonJS Require

```javascript
const { encode, decode } = require('@devtools-at/mac-generator');
```

### Browser (CDN)

```html
<script src="https://unpkg.com/@devtools-at/mac-generator"></script>
<script>
  const result = DevToolsMacGenerator.encode('data');
</script>
```
...
### **[MAC Address Generator - DevTools.at](https://devtools.at/tools/mac-generator)**
